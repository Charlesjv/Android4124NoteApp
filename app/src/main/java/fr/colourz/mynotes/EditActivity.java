...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageNote = findViewById(R.id.image);
    ...
    public void chooseImage(View objectView){
        try{
            ...
            startActivityForResult(objectIntent.createChooser(objectIntent,"Select File"), PICK_IMAGE_REQUEST);
        }
        catch (Exception e){
            Toast.makeText(this, e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                if (resultCode == RESULT_OK) {
                    if (requestCode == PICK_IMAGE_REQUEST) {
                        ...
                        if (null != imageFilePath) {
                            ...
                            String path = getPathFromURI(imageFilePath);
...
//                            Log.i(TAG, "Image Path : " + path);
                            ...
                            findViewById(R.id.image).post(new Runnable() {
                                @Override
                                public void run() {
                                    ((ImageView) findViewById(R.id.image)).setImageURI(imageFilePath);
                                }
                            });
    ...
    public  void storeImage( View view){
        try{
            if ( imageNote.getDrawable()!= null) {
                ...
                objectDatabaseHelper.storeImages(new Note(imageToStore));
            }else{
